...
import { Plus, Trash2, LogOut, Shield, Save, Loader2, Calendar } from "lucide-react";
...
export default function WorkspaceSettingsPage() {
        ...
        const fetcher = async () => {
            try {
                ...
                if (handleResponse(resData)) {
                    ...
                    setOriginalMembers(resData.data.members);

                    const currentUser = resData.data.members.find(
    ...
    return (
        <div className="mx-auto max-w-5xl space-y-8 px-4 py-8 my-12">
            {/* Header Section */}
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold tracking-tight">{workspaceData.title}</h1>
                    <Badge
                        variant="outline"
