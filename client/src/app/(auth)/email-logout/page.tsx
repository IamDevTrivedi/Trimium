                ...
                <CardContent className="flex flex-col items-center justify-center gap-6 py-12 text-center">
                    {status === "loading" && (
                        <>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-muted-foreground">Processing your logout request...</p>
                            </div>
                        </>
                    )}
                    ...
                    {status === "error" && (
                        <>
                            ...
                            <div className="space-y-2">
                                <h2 className="text-lg font-semibold text-destructive">Logout Failed</h2>
                    ...
                    {status === "success" && (
                        <>
                            ...
                            <div className="space-y-2">
                                <h2 className="text-lg font-semibold text-foreground">Logged Out</h2>
                                <p className="text-sm text-muted-foreground">{message}</p>
                            </div>
                        </>
                    )}
